          ...
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
            <div>
              ...
              <p className="mt-6 max-w-3xl text-base leading-8 text-neutral-400">
                Acquista ambienti 3D extra per le tue mostre digitali. Una volta
                comprato, il template resta collegato al tuo account e potrai
                usarlo indipendentemente dal piano attivo.
              </p>
            </div>
                  ...
                  <div className="p-6">
                    ...
                    {!description && (
                      <p className="mt-5 min-h-24 text-sm leading-7 text-neutral-500">
                        Template premium acquistabile singolarmente e collegato
                        per sempre al tuo account.
                      </p>
                    )}
